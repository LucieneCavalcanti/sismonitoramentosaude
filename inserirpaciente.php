...
<body>
    ...
    //montar a instrução SQL
        $sql = "insert into tbpacientes (nome,email,senha,datanascimento,convenio) 
        values ('$nome','$email','$senha','$datanascimento','$convenio')";

        require_once "conexao.php"; //conectar com o banco
        $conn->exec($sql); //executar
        echo "<p>Paciente salvo com sucesso</p>";
