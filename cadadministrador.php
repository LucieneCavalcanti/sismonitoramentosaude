...
<?php
    ...
    $sql="Select * from tbadministradores order by nome";
    $result = $conn->query($sql);
    $dados = $result->fetchAll(PDO::FETCH_ASSOC);
    foreach ($dados as $linha) {
        echo "<tr><td>".$linha["id"]."</td><td>".$linha["nome"]."</td><td> ".$linha["email"]."</td>".
        "<td><a href='editaradministrador.php?id=".$linha["id"]."'>Editar</a> ".
        "<a href='excluiradministrador.php?id=".$linha["id"]."'>Excluir</a></td>".
        "</tr>";
